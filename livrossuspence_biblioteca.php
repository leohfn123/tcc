  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="col-sm-6 mb-3 mb-sm-0">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">quem so eu </h5>
            <img src="img/img19.jpeg" height="250px" >
      ...
      <div class="col-sm-6">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">quem comeu o cu de quem </h5>
            <img src="img/img20.png" height="250px" >
    ...
    <div class="col-sm-6 ">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">a historia do final da  vida  </h5>
          <img src="img/img21.jpeg" height="250px">
          <p class="card-text">conta a historia de uma criança que está em busca de seu pai pelo mundo</p>
    ...
    <div class="col-sm-6">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">voltando ao inicio</h5>
          <img src="img/img18.jpeg" height="250px" >
          <p class="card-text">conta a historia de um homen que gosta de se aventurar pelo mundo</p>
